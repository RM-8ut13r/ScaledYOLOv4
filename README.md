...
This is the implementation of "[Scaled-YOLOv4: Scaling Cross Stage Partial Network](https://arxiv.org/abs/2011.08036)" using the PyTorch framework.
Edited by R. Butler to use relative imports and include an onnx export script.
